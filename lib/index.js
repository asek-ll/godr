    ...
    return self.auth.request(uploadBody, request.handleResponse(function (err, body, res) {
      ...
      readable.on('data', function(chunk) {
        ...
        progress += chunk.length;
          ...
          console.log(uploadPartBody);
        return self.auth.request(uploadPartBody, request.handleResponse(function (err, body, res) {
          console.log(err);
          console.log('upload got %d bytes of data', chunk.length);
